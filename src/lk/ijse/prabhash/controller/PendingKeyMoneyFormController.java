...
import lk.ijse.prabhash.services.custom.PendingKeyMoneyService;
...
public class PendingKeyMoneyFormController {
    ...
    final private PendingKeyMoneyService pendingKeyMoneyBO = (PendingKeyMoneyService) ServiceFactory.getInstance().getService(ServiceType.PENDINGKEYMONEY);
